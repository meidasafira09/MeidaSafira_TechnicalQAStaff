...
//Click menu Login
WebUI.click(findTestObject('Login_PageObject/menu_Login'), FailureHandling.STOP_ON_FAILURE)

// Input email and password => calling global variables in profile env
...
// Check visibility profile name is "meitesting"
WebUI.verifyElementVisible(findTestObject('Login_PageObject/profilname_meitesting'))
